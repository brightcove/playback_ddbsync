...
[![GoDoc](http://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/brightcove/playback_ddbsync)
...
```bash
$ git clone http://github.com/brightcove/playback_ddbsync && cd ddbsync
$ glide install
$ go run main.go
```
